...
{#if permission === 'default'}
  <div class="bg-alert text-abru-800 flex flex-row items-center rounded-lg px-3 py-2">
    ...
    >
    <button
      class="bg-abru-900 text-alert hover:bg-abru-800 rounded px-7 py-[5px] text-base font-bold uppercase"
      on:click={requestPermission}>Allow notifications</button
    >
  </div>
{:else if permission === 'denied'}
  <div class="bg-accent-600 text-abru-800 rounded px-3 py-2 text-lg font-medium">
    <span
